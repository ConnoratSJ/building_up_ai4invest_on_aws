      ...
      <div>
        <div>
          ...
          {step === 1 && (
            <>
              <div>
                ...
                <select name="Age Group" value={formData["Age Group"]} onChange={handleChange} >
                ...
                <select name="Education Level" value={formData["Education Level"]} onChange={handleChange} >
                  <option value="">-- Please select an option --</option>
                ...
                <select name="Marital Status" value={formData["Marital Status"]} onChange={handleChange} >
                  <option value="">-- Please select an option --</option>
                ...
                <label >Number of financially dependent children</label>
                <select name="Financially dependent children" value={formData["Financially dependent children"]} onChange={handleChange} >
                  <option value="">-- Please select an option --</option>
          ...
          {step === 2 && (
            ...
            <label >Over the past year, spending relative to income</label>
            <select
            ...
            <label >In a typical month, how difficult to cover expenses/pay bills</label>
            <select
            ...
            <label >Have set aside emergency funds to cover 3 months’ expenses</label>
            <select
            ...
            <label >Willingness to take financial risks when investing</label>
            <select
                name="risk_tolerance"
          ...
          {step === 3 && (
            ...
            <label >Do you have a savings account, money market account, or CDs?</label>
            <select
            ...
            <label >Have any employer-sponsored retirement plan (401(k), pension, etc.)?</label>
            <select
            ...
            <label >Do you regularly contribute to a retirement account (401(k), IRA, etc.)?</label>
            <select
            ...
            <label >Not including retirement accounts, do you have investments in stocks/bonds/mutual funds?</label>
            <select
            ...
            <label >Do you [or your spouse/partner] currently own your home?</label>
            <select
                name="Homeownership"
          ...
          {step === 4 && (
            ...
            <label >Frequency of thinking about personal financial condition</label>
            <select
            ...
            <label >“I am good at dealing with day-to-day financial matters”</label>
            <select
                name="Self-efficacy"
            ...
            <label >On a scale from 1 to 7, where 1 means very low and 7 means very high, how would you assess your overall financial knowledge?</label>
            <select
